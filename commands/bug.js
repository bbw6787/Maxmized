module.exports.addbug = function(msg, args) {
    if ( msg.channel.name !== "bugs" ) {
        msg.author.send("You can only use that command in the #bugs channel :hushed:")
        .catch(console.error);
        return;
    }
    if ( args.length < 5 ) {
...
Correct usage: **!bug (your ign) (platform ID) (description)**
...
Thank you for your time :relaxed:`)
     ...
     **ID: **#' + id + '\n */
    var embed = {
        "title": "Bug added by " + msg.author.tag,
